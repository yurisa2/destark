...
```
s3://adveng-pipeline/unifile_test/result_300m_max.tif
s3://adveng-pipeline/unifile_test/result_300m_minimum.tif
s3://adveng-pipeline/unifile_test/result_300m_median.tif
s3://adveng-pipeline/unifile_test/result_300m_mode.tif
s3://adveng-pipeline/unifile_test/result_300m_round_up.tif
s3://adveng-pipeline/unifile_test/result_300m_round_down.tif
s3://adveng-pipeline/unifile_test/result_300m_default.tif
```
...
```
https://console.aws.amazon.com/elasticmapreduce/home?region=us-east-1#/clusterDetails/j-2XV0JESM33Y1E
```
...
# Submit step
aws emr add-steps --cluster-id j-2XV0JESM33Y1E --steps file://step.json
```
