...
# Final working version that addresses Spark serialization limits
...
echo "=== Running All FIS Models with Spark Submit (Final Working) ==="
...
run_model() {
    ...
    # Set Java 17 and optimized Spark configuration for YARN containers
    spark-submit \
        --master yarn \
        --deploy-mode cluster \
