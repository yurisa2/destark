...
# Working version using original S3 URLs with proper rasterio configuration
...
echo "=== Running All FIS Models with Spark Submit (Working Version) ==="
...
run_model() {
    ...
    # Set Java 17 and proper S3 configuration for YARN containers
    spark-submit \
        --master yarn \
        --deploy-mode cluster \
