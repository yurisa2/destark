#!/usr/bin/env python3
"""
Spark FIS Processing - Run directly on EMR master node
This script processes all FIS configurations using distributed Spark
"""
...
packages = ["numpy", "rasterio", "scikit-fuzzy", "boto3", "networkx", "pyspark"]
