#!/usr/bin/env python3
"""
EMR FIS Processing - Fixed Version
Uses existing FIS logic and configs, but compatible with EMR Java 8
"""
...
def process_config_spark(config_name):
    ...
    # Create Spark session for EMR processing
    ...
    num_partitions = min(100, len(chunks))  # Limit partitions for EMR
...
def main():
    ...
    print("This will process all configurations using distributed Spark on EMR")
