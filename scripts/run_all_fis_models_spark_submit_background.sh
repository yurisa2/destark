...
# Background version that submits jobs and returns immediately
...
echo "=== Running All FIS Models with Spark Submit (Background) ==="
echo "Social: $SOCIAL_TIFF"
echo "Environmental: $ENVIRONMENTAL_TIFF"
echo "Strategic: $STRATEGIC_TIFF"
echo "Output prefix: $OUTPUT_PREFIX"

# Define configs with original S3 URLs (which work)
...
run_model() {
    ...
    echo "=== Submitting $model_name model ==="
...
echo "Check status with: yarn application -list"
