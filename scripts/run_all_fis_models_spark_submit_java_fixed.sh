...
# Fixed version that properly configures Java 17 for both master and YARN containers
# This resolves the JNI error that occurs in YARN containers
...
echo "=== Running All FIS Models with Spark Submit (Java Fixed) ==="
