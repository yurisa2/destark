...
# Conservative version with very small block sizes to avoid serialization issues
...
echo "=== Running All FIS Models with Spark Submit (Conservative) ==="
...
run_model() {
    ...
    # Set Java 17 and very conservative Spark configuration
    spark-submit \
        --master yarn \
        --deploy-mode cluster \
