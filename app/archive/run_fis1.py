...
regra3 = ctrl.Rule(ambiental['baixo'] & socioeconomico['baixo'] & estrategico['baixo'], saida['BX'])
regra4 = ctrl.Rule(ambiental['baixo'] & socioeconomico['medio'] & estrategico['alto'], saida['BX'])
regra5 = ctrl.Rule(ambiental['baixo'] & socioeconomico['medio'] & estrategico['medio'], saida['BX'])
...
regra9 = ctrl.Rule(ambiental['baixo'] & socioeconomico['alto'] & estrategico['baixo'], saida['Med'])
...
regra12 = ctrl.Rule(ambiental['medio'] & socioeconomico['baixo'] & estrategico['baixo'], saida['A'])
regra13 = ctrl.Rule(ambiental['medio'] & socioeconomico['medio'] & estrategico['alto'], saida['Med'])
regra14 = ctrl.Rule(ambiental['medio'] & socioeconomico['medio'] & estrategico['medio'], saida['Med'])
regra15 = ctrl.Rule(ambiental['medio'] & socioeconomico['medio'] & estrategico['baixo'], saida['A'])
regra16 = ctrl.Rule(ambiental['medio'] & socioeconomico['alto'] & estrategico['alto'], saida['Med'])
regra17 = ctrl.Rule(ambiental['medio'] & socioeconomico['alto'] & estrategico['medio'], saida['A'])
regra18 = ctrl.Rule(ambiental['medio'] & socioeconomico['alto'] & estrategico['baixo'], saida['A'])
regra19 = ctrl.Rule(ambiental['alto'] & socioeconomico['baixo'] & estrategico['alto'], saida['A'])
...
regra22 = ctrl.Rule(ambiental['alto'] & socioeconomico['medio'] & estrategico['alto'], saida['A'])
...
consolidated.to_csv("python_move/consolidated1.csv", index=False)